...
<nav class="navbar navbar-dark bg-dark navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                ...
                if(!isset($user)){
                    ...
                    print "
                        ...
                        <p class='ml-4 mt-2'>Pseudo: " . $user->getPseudo() . "</p><p class='ml-4 mt-2'>Role: " . $user->getRole() . "</p>
            ...
            <?php
            if(isset($titrepage) && $titrepage == "Toutes les news:") {
                print "
                <li class='nav-item dropdown'>
                    <a class='nav-link dropdown-toggle' href='#' id='navbarDropdown' role='button' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>
                        Stats
                    ...
                    <div class='dropdown-menu' aria - labelledby = 'navbarDropdown' >
                            <p class='text-center'>Vos messages : ";
                            if (isset($user)) {
                                if (isset($cookie)) {
                                    print $cookie;
                                } else {
...
<main class="container-fluid">
    ...
    if(isset($news) && $news != null) {
        foreach ($news as $val) {
            ...
            if(isset($user) && $user->getRole() == "Admin")
                print "<a class='btn btn-dark float-right' href='index.php?action=supp_news&newsid=" . $val->getId() . "'>Supprimer</a>";
            ...
            if(isset($comm)){
                if(isset($user) && $user->getRole() == "Utilisateur"){
                    print "
